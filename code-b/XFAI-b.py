# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 16:01:00 2018
...
data = pd.read_csv('feature_count-b1.csv')
...
rate_feature = ['adid_rate', 'advert_id_rate', 'orderid_rate', 'advert_industry_inner_first_rate', 'advert_industry_inner_second_rate', 'advert_name_rate', 'campaign_id_rate', 
				...
				'app_cate_id_rate', 'f_channel_rate', 'app_id_rate', 'inner_slot_id_rate', 'city_rate', 'carrier_rate', 'province_rate', 'nnt_rate', 'devtype_rate', 'make_rate', 
				'model_rate', 'area_rate', 'os_rate', 'osv_rate', 'os_osv_rate', 'os_name_rate']
...
#                   'carrier_h_rate', 'province_h_rate', 'nnt_h_rate', 'devtype_h_rate', 'osv_h_rate', 'os_h_rate', 'os_name_h_rate', 'make_h_rate', 'model_h_rate', 'wh_ratio_h_rate']
...
predict_result[['instance_id', 'predicted_score']].to_csv("XFAI-b%s.csv" % now, index=False)